...
public class thermostatupActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thermostatup);
    ...
    private String getConnection(String status1, String status2) {
        ...
        try{
            ...
            HttpPost httppost = new HttpPost("http://192.168.1.3/thermo_up.php");
